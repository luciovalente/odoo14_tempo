...
;(function($) {
	...
	var Mapplic = function(element) {
		...
		self.init = function(options) {
			...
			// INFO: Process map data.

			// INFO: made slightly changes when load map from element 'data' attribute. Do tests.
			if (self.el.data('mapdata')) {
				...
				// INFO: loading .json file with AJAX.
				$.getJSON(self.o.source, function(data) {
					...
					// INFO: produce just console logs to not bother client user.
					// alert('Data file missing or invalid!\nMake sure to run the script through web server.');
				});
			}
			else {
				// INFO: inline json object.
